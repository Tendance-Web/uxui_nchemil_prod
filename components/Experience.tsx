        ...
        <div className="lg:col-span-8 space-y-12 relative">
           ...
           {EXPERIENCE_DATA.map((exp) => (
             <div key={exp.id} className="relative md:pl-12 group">
               {/* Dot */}
               <div className="absolute left-[-4px] top-2 w-2 h-2 rounded-full bg-zinc-600 group-hover:bg-primary transition-colors hidden md:block border border-background"></div>
